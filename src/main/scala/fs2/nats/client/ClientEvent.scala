...
/**
 * Events emitted by the NATS client for observability.
 * These events are available through NatsClient.events stream.
 */
...
object ClientEvent:
   ...
   *
   * @param serverInfo The server INFO received upon connection
   */
   ...
   * @param willReconnect Whether the client will attempt to reconnect
   */
   ...
   *
   * @param serverInfo The server INFO from the new connection
   * @param attempt The reconnection attempt number that succeeded
   */
   ...
   * @param fatal Whether this error is fatal and will cause disconnection
   */
   ...
   * @param dropped The number of messages dropped (if applicable)
   */
  ...
  /**
   * Server entered Lame Duck Mode and will shut down soon.
   * Client should prepare for disconnection.
   */
   ...
   *
   * @param serverInfo The updated server INFO
   */
